    ...
    def handle_key(key):
        ...
        if key == ord('x'):
            ...
            if current_landmark_index < len(landmark_names):
                ...
                print(f"Skipping {landmark_names[current_landmark_index]}")
...
#     # print_bird_landmark_pairs(selected_landmarks=selected_l
#     # andmarks, bird_coords=bird_coords)

#     # print(bird_closest_landmarks(selected_landmarks=selected_landmarks, bird_coords=bird_coords))
