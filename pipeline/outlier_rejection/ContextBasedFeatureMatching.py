...
def match_keypoints_to_closest_landmark(keypoint_coords, selected_landmarks, image_path):
...
def get_keypoint_match_pairs(kp1, kp2, matches, image1_path, image2_path, selected_landmarks1, selected_landmarks2):
...
# img, kp1, kp2, matches = match_features(img1_path=image1_name, img2_path=image2_name, bbox_name_1=birds1_name, bbox_name_2=birds2_name, show=False)
...
# get_keypoint_match_pairs(kp1=kp1, kp2=kp2, matches=matches, image1_path=image1_path, image2_path=image2_path, selected_landmarks1=selected_landmarks1, selected_landmarks2=selected_landmarks2 )

# selected_landmarks1 = select_landmarks(image_path=image1_path, landmark_names=landmark_names)
# selected_landmarks2 = select_landmarks(image_path=image2_path, landmark_names=landmark_names)

# keypoint1_coordinates = get_keypoint_coordinates(keypoints1_path)
# keypoint2_coordinates = get_keypoint_coordinates(keypoints2_path)

# junk1, junk11, keypoint_landmark_dictionary = match_keypoints_to_closest_landmark(keypoint_coords=keypoint1_coordinates, selected_landmarks=selected_landmarks1, image_path=image1_path)
# junk2, junk22, keypoint_landmark_dictionary = match_keypoints_to_closest_landmark(keypoint_coords=keypoint2_coordinates, selected_landmarks=selected_landmarks2, image_path=image2_path)
